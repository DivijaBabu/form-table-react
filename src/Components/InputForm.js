    ...
    return (
      <div >
        ...
        <form onSubmit={this.addItem}>
          <input type="text" value={this.state.ValueItem.firstname} onChange={this.handleChange} id="inputbutton"placeholder="Enter First Name" name="firstname" />
          <input type="text" value={this.state.ValueItem.lastname} onChange={this.handleChange} id="inputbutton"placeholder="Enter Last Name" name="lastname" />
